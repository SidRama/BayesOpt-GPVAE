...
class ModelArgs:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--csv_file_label_unmasked', type=str, help='Name of unmasked label file', required=False)
        ...
        self.parser.add_argument('--csv_file_label_mask', type=str, help='Name of mask file', default=None)
        ...
        self.parser.add_argument('--dataset_type', required=False, choices=['RotatedMNIST', 'MNIST'],
        ...
        self.parser.add_argument('--id_covariate', type=int, help='Index of ID (unique identifier) covariate', required=False)
        self.parser.add_argument('--M', type=int, help='Number of inducing points', required=False)
        self.parser.add_argument('--P', type=int, help='Number of unique instances', required=False)
        self.parser.add_argument('--T', type=int, help='Number of longitudinal samples per instance', required=False)
        ...
        self.parser.add_argument('--iter_num', type=int, default=None, help='Iteration number. Useful for multiple runs.')
        ...
        self.parser.add_argument('--dropout', type=float, default=0.0, help='Probability for dropout')
        self.parser.add_argument('--dropout_input', type=float, default=0.0, help='Probability for dropout at input layer')
        self.parser.add_argument('--GP_VAE', type=str2bool, default=True, help='Use a GP prior VAE')
